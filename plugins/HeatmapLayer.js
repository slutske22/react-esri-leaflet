...
var _esriLeafletHeatmap = _interopRequireDefault(require("esri-leaflet-heatmap"));
...
var createEsriLayer = function createEsriLayer(props, context) {
  var instance = new _esriLeafletHeatmap["default"].featureLayer(_objectSpread({}, props));
  return {
    instance: instance,
    context: context
  };
...
var HeatmapLayer = (0, _core.createLayerComponent)(createEsriLayer, updateEsriLayer);
